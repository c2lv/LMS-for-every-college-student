/**
 * Kakao Javascript SDK for Kakao Open Platform Service - v1.0.39
 *
    ...
    (function e(t, n, r) {
            ...
            module.exports = (function() {
                ...
                var rules = {
                    request: {
                        required: {
                            url: function(url) {
                                return _.isOneOf(_.keys(rules.api))(url);
                            }
                        },
                        optional: {
                            data: _.isObject,
                            files: function(obj) {
                                return _.passesOneOf([_.isArray, _.isFileList])(obj) &&
        ...
        3: [function(require, module, exports) {
            ...
            module.exports = (function() {
                ...
                var LOGIN_POPUP_NAME = 'kakao_login';
                 ...
                 * approvalType: approval type. 'project'
                 */
                ...
                Auth.login = function(settings) {
                    ...
                    window.open(getAuthUrl(), LOGIN_POPUP_NAME, POPUP_FEATURES);
        ...
        4: [function(require, module, exports) {
            ...
            module.exports = (function() {
                ...
                _k.URL = {
                    ...
                    storyIcon: 'https://dev.kakao.com/sdk/js/resources/story/icon_small.png'
                };
        ...
        8: [function(require, module, exports) {
            module.exports = (function() {
                ...
                var STORY_BUTTON_CLASS = '.kakaostory-share-button';
                ...
                Story.createShareButton = function(settings) {
                    ...
                    var shareUrl = getShareURL(settings.url);
                    ...
                    var handler = function(e) {
                        ...
                        window.open(shareUrl, POPUP_NAME, POPUP_FEATURES);
                    };
                ...
                // create share buttons in all elements with STORY_BUTTON_CLASS
                var buttons = document.querySelectorAll(STORY_BUTTON_CLASS);
                if (buttons) {
        ...
        14: [function(require, module, exports) {
            // https://github.com/html5crew/web2app v1.0.5
            module.exports = (function() {
