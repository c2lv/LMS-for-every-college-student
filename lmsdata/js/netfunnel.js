...
NetFunnel.TS_CONFIG_USE = true; // 무조건 Config에 있는 IP 와 PORT로 사용 //default : false
...
// Logo Image Data -------------------------------------------------------------
//   - height:16 pixel
//   - GIF Format Data (Base64 Encoding) //이미지 파일을 인코딩
